  ...
  <div class="main">
    ...
    <form v-on:submit.prevent="addNewReview()"
      ...
      <div class="form-element">
        ...
        <input id="reviewer" placeholder="Reviewer's Name" type="text" v-model.trim="newReview.reviewer" />
      </div>
      <div class="form-element">
      ...
      <input type="button" value="Cancel" v-on:click.prevent.stop="resetForm()">
    </form>

    <p class="notFound" v-if="filteredReviews.length === 0">No {{ filter }} Star Reviews found</p>
...
export default {
  ...
  computed: {
    ...
    numberOfOneStarReviews() {
      return this.calculateNumberOfReviews(1);
    },
    numberOfTwoStarReviews() {
      return this.calculateNumberOfReviews(2);
    },
    numberOfThreeStarReviews() {
      return this.calculateNumberOfReviews(3);
    },
    numberOfFourStarReviews() {
      return this.calculateNumberOfReviews(4);
    },
    numberOfFiveStarReviews() {
      return this.calculateNumberOfReviews(5);
    }
  },
  methods: {
    calculateNumberOfReviews(numberOfStars) {
...
div.main div.well span.amount:hover {
