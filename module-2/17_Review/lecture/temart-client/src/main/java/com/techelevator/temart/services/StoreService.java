...
public class StoreService {
    ...
    public Wishlist addNewWishlist(String wishListName){
        ...
        HttpEntity<Wishlist> entity = new HttpEntity<Wishlist>(new Wishlist(wishListName), headers);
        ResponseEntity<Wishlist> responseEntity =  restTemplate.exchange(url, HttpMethod.POST, entity, Wishlist.class);
        Wishlist returnedWishlist = responseEntity.getBody();
