    ...
    */
    ...
    public String[] discardTopCard(String[] remainingDeck) {
        if(remainingDeck.length > 0) {
            String[] shortenedDeck = new String[remainingDeck.length - 1];

            for(int i = 0; i <remainingDeck.length - 1; i++){

                shortenedDeck[i] = remainingDeck[i + 1];
            }
            return shortenedDeck;

        }
        else{
            String[] zeroCardDeck = new String[remainingDeck.length];
            return zeroCardDeck;
        }
