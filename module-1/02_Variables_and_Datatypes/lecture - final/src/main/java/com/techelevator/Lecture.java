	...
	public static void main(String[] args) {
		...
		*/
		...
		2. Create a variable to hold a double and call it half.
			Set it to 0.5.
		*/
		double half = 0.5;  // Declaration and Assignment in one step
		...
		3. Create a variable to hold a String and call it name.
			...
			String may contain special escape characters for characters
			we can't directly type, for example:
				\n - new line
				\t - tab
		*/
		...
		*/
		...
		your phone.
		*/
		int percentOfPhoneBatteryRemaining;
		...
		*/
		...
		int anotherSmallNumber = (int) largeNumber;
